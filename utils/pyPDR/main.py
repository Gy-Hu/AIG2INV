...
if __name__ == '__main__':
    ...
    #args = parser.parse_args(['./nusmv.reactor^4.C.aag','-d','off'])
    args = parser.parse_args(['./nusmv.syncarb5^2.B.aag','-d','off'])
    #args = parser.parse_args(['./nusmv.syncarb10^2.B.aag','-d','ig'])
    #args = parser.parse_args(['./nusmv.syncarb5^2.B.aag','-d','ig'])
