...
def dump4check_map(cex_clause_pair_list_prop,aag_name,m, return_after_finished = False):
...
def convert_one_aag(aag_name, cnf_name, model_name, g1_list, g2_list):
    ...
    if dump4check_map(cex_clause_pair_list_prop,aag_name,m, return_after_finished = True)!= None: return
