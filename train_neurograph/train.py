...
if __name__ == "__main__":
    ...
    args = parser.parse_args(['--task-name', 'neuropdr_'+ datetime_str.replace(' ', '_'), 
                              ...
                              '--epochs', '512',
                              '--train-file', 'dataset_hwmcc2020_all_only_unsat_abc_thorough_0/bad_cube_cex2graph/json_to_graph_pickle/',  
                              '--val-file', 'dataset_hwmcc2020_all_only_unsat_abc_thorough_0/bad_cube_cex2graph/json_to_graph_pickle/',
                              '--mode', 'train',
                              '--gpu-id', '1',
                              '--batch-size', '1',
                              '--pos-weight', '4',
